...
export const siteConfig: SiteConfig = {
	title: "Angor Blog", // Site title, displayed in the browser tab
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		LinkPreset.About,		{
			name: "Angor",
			url: "https://angor.io", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Angor",  
	bio: "A decentralized crowdfunding protocol built on Bitcoin and Nostr",
		links: [
		{
			name: "Website",
